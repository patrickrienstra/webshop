<div class="loginpageformleft">
    <div class="form">
        <form class="login-form">
            ...
            Address: <br><input type="text" name="adres" value="<?php echo $persoonsgegevens['Address']; ?>"
                                disabled><br>
            <input type="text" name="city" value="<?php echo $persoonsgegevens['City']; ?>" disabled><br>
            Postalcode: <br><input type="text" name="postalcode" value="<?php echo $persoonsgegevens['Zipcode']; ?>"
                                   disabled><br>
            ...
            Phone Number: <br><input type="text" name="phonenumber"
                                   value="<?php echo $persoonsgegevens['PhoneNumber']; ?>" disabled>
        </form>
        <?php
...
<div class="loginpageformright">
    <div class="form">
        <div class="login-form">
            ...
            echo 'Sub Totaal: $' . $subtotaal . '<br>';
            echo 'BTW: $' . $taxamount . '<br>';
            echo 'Totaal: $' . $totaal;
            ?>
        </div>
    </div>
...
<div class="loginpageformright">
    <div class="form payment-box">
        <form class="payment" method="post" action="payment.php">
            <input type="radio" name="methode" value="1" required> Ideal<br>
